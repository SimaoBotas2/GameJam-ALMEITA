...
const INTRO_CLIPS = [
	preload("res://assets/sound/Jessie_Ken_3.1.wav"),
	preload("res://assets/sound/SIH_3.1.wav"),
	preload("res://assets/sound/Jessie_Ken_3.2.wav"),
	preload("res://assets/sound/SIH_3.2.wav"),
	preload("res://assets/sound/Jessie_Ken_3.3.wav")
]
